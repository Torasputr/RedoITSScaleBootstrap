...
@section('content')
    ...
    <section class='tentang-body'>
        <div class='px-5'>
            {{-- Milestone Start --}}
            <div class='milestone hidden row py-5 align-items-center gap-4 d-flex justify-content-center'>
                <div class='col-md-5'>
                ...
                <div class='col-md-6'>
                    ...
                    <div class='d-flex align-items-center justify-content-around py-3 gap-1'>
                        <button class='px-2 rounded-pill fs-6 fs-md-1 fw-semibold py-1 milestone-button hidden childnimate' id='2014-button'>2014</button>
                        <button class='px-2 rounded-pill fs-6 fs-md-1 fw-semibold py-1 milestone-button hidden childnimate' id='2018-button'>2018</button>
                        <button class='px-2 rounded-pill fs-6 fs-md-1 fw-semibold py-1 milestone-button hidden childnimate' id='2020-button'>2020</button>
                        <button class='px-2 rounded-pill fs-6 fs-md-1 fw-semibold py-1 milestone-button hidden childnimate' id='2023-button'>2023</button>
                        <button class='px-2 rounded-pill fs-6 fs-md-1 fw-semibold py-1 milestone-button hidden childnimate' id='2024-button'>2024</button>
                    </div>
                    <div class='hidden'>
    ...
    <section class='mx-5 py-5'>
        ...
        <div class='row align-items-center'>
            <div class='col-md-6 d-flex justify-content-center hidden'>
                <div class='row'>
                    <div class='col hidden childnimate'>
    ...
    <section class='tentang-body p-5'>
        <div class='row align-items-center justify-content-center hidden'>
            <div class='col-md-6'>
                ...
                <div class='d-flex align-items-center gap-4 gap-md-3 hidden childnimate'>
    ...
    <section class='mx-5'>
        <div class='desktop'>
            ...
            <div class='grid-cols-3 pb-5'>
                <button class='rounded sertif-button hidden childnimate' onclick="showModal('{{ asset('images/tentang/sertifikat/diniargeo/diniargeo.webp') }}')">
                    <img class='sertif-thumbnail border rounded' src="{{ asset('images/tentang/sertifikat/diniargeo/diniargeo.webp') }}" alt="">
                </button>
                <button class='rounded sertif-button hidden childnimate' onclick="showModal('{{ asset('images/tentang/sertifikat/iso/isi.webp') }}')">
                    <img class='sertif-thumbnail border rounded' src="{{ asset('images/tentang/sertifikat/iso/thumbnail.webp') }}" alt="">
                </button>
                <button class='rounded sertif-button hidden childnimate' onclick="showModal('{{ asset('images/tentang/sertifikat/imi/imi.webp') }}')">
